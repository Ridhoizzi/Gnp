...
cek_reg_mode() {
    until [[ $MYIP =~ ^[0-9.]+$ && ${CLIENT_EXISTS} == '1' ]]; do
        ...
        CLIENT_EXISTS=$(wget -qO- https://raw.githubusercontent.com/Ridhoizzi/izinvps/ip | grep -w $MYIP | wc -l)
...
"'&reply_markup={"inline_keyboard":[[{"text":"ᴏʀᴅᴇʀ🐳","url":"https://t.me/Ridhoizzi"},{"text":"ɪɴꜱᴛᴀʟʟ🐬","url":"https://t.me/rstorx/25"}]]}'
